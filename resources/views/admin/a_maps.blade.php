            ...
            @if(auth()->user()->role == 1)
                <nav class="h-screen hidden lg:block shadow-lg relative w-14 pr-14">
                    <div class="fixed flex flex-col top-0 left-0 w-18 bg-gray-100 h-full border-2 mr-6">
                        ...
                        <a href="/a_daftar"
                            class="border-b-2 border-transparent dark:hover:text-gray-200 hover:border-blue-500 mx-0 sm:mx-3 mt-3 mb-3 {{ $active === 'a_daftar' ? 'active: bg-green-400 ' : '' }}"
                            title="Daftar">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                        ...
                        <a href="/a_info"
                            class="border-b-2 border-transparent dark:hover:text-gray-200 hover:border-blue-500 mx-0 sm:mx-3 mt-3 {{ $active === 'a_info' ? 'active: bg-green-400 ' : '' }}"
                            title="info">
            ...
            @if(auth()->user()->role == 2)
                <nav class="h-screen hidden lg:block shadow-lg relative w-14 pr-14">
                    <div class="fixed flex flex-col top-0 left-0 w-18 bg-gray-100 h-full border-2 mr-6">
                        ...
                        {{-- <a href="/daftar"
                            class="border-b-2 border-transparent dark:hover:text-gray-200 hover:border-blue-500 mx-0 sm:mx-3 mt-3 mb-3 {{ $active === 'daftar' ? 'active: bg-green-400 ' : '' }}"
                            title="Daftar">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                ...
                <div class="order-last md:order-first w-100 md:w-1/4 md:mr-16">
                    ...
                    <div class="flex flex-row">
                        <div class="flex flex-wrap">
                            <div class="w-full h-full sm:w-6/12 md:w-4/12 ml-2 mt-2">
                    ...
                    <div id="lokasi" class="ml-3">
                        ...
                        @foreach($daftar as $item)
                            <div style="width: 350px;" class="mt-2 h-30 border-2 border-gray-500 rounded-lg pr-1" >
                                ...
                                <div class="flex ml-3">
                                    <span class="ml-1 text-sm">Alamat : Desa {{ $item->desa }} , Kec.
                                        {{ $item->kecamatan }}</span>
                                </div>
                                <div class="flex  ml-3">
...
function getLocation() {
    ...
    <div class="flex  ml-2">
        <span class="ml-1  text-sm text-center"> Buka : ${response.hari} WIB</span>
    </div>
    <div class="flex  ml-2">
