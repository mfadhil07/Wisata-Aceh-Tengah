...
@section('isi')
    ...
    <div class="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10 mr-2">
    ...
    <section class="w-full bg-gradient-to-br pl-2 mr-2">
        <h1 class="mt-2 ml-4 mb-4 font-semibold text-3xl text-center"> Rekomendasi Objek Wisata <span
    ...
    <section>
        ...
        <div class="grid justify-center md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 my-10 ml-4 mr-2">
    ...
    <footer class="text-center bg-green-600 text-white">
        <div class="container pt-6 w-full mr-2 ">
