...
@section('isi')
    <h1 class="mt-4 ml-10 text-3xl font-bold"> Detail Objek Wisata</h1>
            ...
            <div class="flex flex-col justify-center">
                <div class="flex">
                    <div class="ml-6 text-lg">
                        ...
                        <h6 class="mb-2 font-semibold leading-5">
                            Tiket Masuk Rp : <span>  {{ $daftar->tiket }} </span>
                        </h6>
                        <hr class="w-full my-2 border-gray-300" />
                            ...
                            <div class="flex items-center">
                                <div class="flex items-start w-30">
                                    ...
                                    @for ($x = 1; $x <= $daftar->skor; $x++)
                                        <svg class="w-5 h-5 mt-1 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"
                                    ...
                                    @for ($x = 0; $x < $daftar->sisa; $x++)
                                        <svg class="w-5 h-5 mt-1 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                            </path>
